...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <?php require_once 'Mahasiswa/navbar_mhs.php' ?>
    ...
    <section class="content">
      <div class="container-fluid">
            <div class="row dashboard-petugas" style="margin-top:10%;">
              <a class="dashboard-panel" href="<?php echo site_url('Mahasiswa/PengajuanJudul'); ?>" style="background-color:DodgerBlue; margin: auto; margin-top:1rem; margin-bottom:1rem; height: 14rem;">
